...
################################################################################
echo "You are accessing an managed system. This information system contains information with specific requirements imposed by the U.S. Government. Customer reserves the right to monitor, record, and audit information system usage. The information system may be subject to other specified requirement associated with certain types of information. Unauthorized use is prohibited and may result in organizational sanctions and/or criminal and civil penalties." >> /etc/motd
echo "You are accessing an managed system. This information system contains information with specific requirements imposed by the U.S. Government. Customer reserves the right to monitor, record, and audit information system usage. The information system may be subject to other specified requirement associated with certain types of information. Unauthorized use is prohibited and may result in organizational sanctions and/or criminal and civil penalties." > /etc/issue
echo "You are accessing an managed system. This information system contains information with specific requirements imposed by the U.S. Government. Customer reserves the right to monitor, record, and audit information system usage. The information system may be subject to other specified requirement associated with certain types of information. Unauthorized use is prohibited and may result in organizational sanctions and/or criminal and civil penalties." > /etc/issue.net
